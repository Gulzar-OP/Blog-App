...
export default function Games() {
  ...
  const gameBlogs = blogs?.filter(blog => blog.category === "Game");
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <p className='text-gray-600 mb-8'>Game is life, and life is a game.</p>

      {/* If no blogs */}
      {!gameBlogs || gameBlogs.length === 0 ? (
        <p className="text-gray-500">No game blogs available...</p>
      ) : (
