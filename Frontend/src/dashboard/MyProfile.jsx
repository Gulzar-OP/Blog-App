...
export default function MyProfile() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      setImagePreview(res.data.photo?.url || '');
    } catch (err) {
    ...
    <div className="min-h-screen py-24 px-6 md:px-12 lg:px-24 bg-gradient-to-br from-black via-zinc-950/90 to-zinc-900/80 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-zinc-200 via-white to-zinc-300 bg-clip-text drop-shadow-2xl mb-4">
            Personal Dashboard
          </h1>
