  ...
  return (
    <footer className="relative overflow-hidden bg-black pt-24 pb-12 px-6 md:px-12 lg:px-24 border-t-4 border-gradient-to-r from-purple-500/30 to-pink-500/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            ...
            <nav className="space-y-4">
              {[
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 -inset-1 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-all duration-500 -z-10" />
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { icon: FaEnvelope, color: "from-orange-600/90 to-red-600/90", hover: "from-orange-500 to-red-500", href: "mailto:hello@gulblog.com" }
            ...
            <div className="space-y-4 pt-6 border-t border-zinc-800/60">
              <div className="flex items-center gap-3 text-zinc-500 text-sm backdrop-blur-sm p-3 rounded-2xl bg-zinc-900/50 border border-zinc-800/50 hover:bg-zinc-800/30 transition-all duration-300">
                ...
                <a href="mailto:hello@gulblog.com" className="hover:text-orange-400 transition-colors duration-300">hello@gulblog.com</a>
              </div>
              <div className="flex items-center gap-3 text-zinc-500 text-sm backdrop-blur-sm p-3 rounded-2xl bg-zinc-900/50 border border-zinc-800/50 hover:bg-zinc-800/30 transition-all duration-300">
        ...
        >
          <div className="text-center text-sm">
            ...
            >
              © {currentYear} <span className="text-purple-400 font-black">GulBlog</span> — 
              Crafted with ❤️ in Haryana, India. All Rights Reserved. | 
      ...
      {/* <style jsx>{`
        ...
        .animate-scan-slow { 
          animation: scan-slow 40s linear infinite; 
        }
        .animate-shimmer { 
