...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-black/90 to-zinc-900 flex items-center justify-center px-4 py-12 overflow-hidden relative">
