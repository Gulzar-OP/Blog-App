  ...
  const handleLogin = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        ...
        {
          headers: {
            "Content-Type": "application/json", // Fixed: Not multipart
          },
        ...
        >
          <div className="text-center mb-10">
            <motion.div
              ...
              className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-3xl backdrop-blur-xl border-2 border-cyan-400/30 p-5"
            >
              <LockClosedIcon className="w-12 h-12 text-cyan-400 mx-auto" />
            </motion.div>
