            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-2xl font-black text-zinc-100 mb-3">Narnaund, Haryana</h4>
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-2xl font-black text-zinc-100 mb-3">+91 98765 43210</h4>
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-2xl font-black text-zinc-100 mb-3">hello@gulblog.com</h4>
